...
//in order to change all App:: shit to the new namespace class system we need to do this

use App\Core\App;//because of this line here, php will know that on this page the App:: is actually App\Core\App
