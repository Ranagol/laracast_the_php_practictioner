<?php
//config stores all the necesarry details for connecting to the db, like db name, password, where to connect, how to handle errors...

return [//this is an array, but before the array there is a return command!
	'database' => [//...there is another array 'database'
		'name' => 'mytodo',
		'username' => 'root',
		'password' => '',
