...
class UsersController {
	...
	public function index(){//THIS IS FOR READING FROM THE DB. This method will be activated by routes.php, with the $router->get('users', 'UsersController@index'). This will get the users from the DB.
	...
	public function store(){//THIS IS FOR WRITING TO THE DB. This method will be activated by the routes.php, by the $router->post('users', 'UsersController@store');. This will submit our users to the DB.
